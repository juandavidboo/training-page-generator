document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let i = 0; i < allTiles.length; i++) {
    ...
    myElem.addEventListener('click', (e) => {
      ...
      if (myLink.getAttribute('href')) {
        ...
        else window.location.href = myTarget;
      } else {
        myLink.click();
      }
    });
  ...
  cal_single = ics();
  cal_single.addEvent('MuleSoft Certification Appreciation Event', 'Everyone who passes a certification exam or extends their certification in the month of October will be invited to our exclusive certification appreciation event on 31st October! There will be games, networking, and announcements, so don’t miss out!', 'APAC', '10/31/2022', '10/31/2022');

  let cal_btn = document.getElementById("cal_btn");
  cal_btn.addEventListener('click', (e) => {
    e.preventDefault();
    cal_single.download('Appreciation Event');
  }, false)
